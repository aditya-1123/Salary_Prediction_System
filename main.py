...
def checkcsv(): # counts no csv files
    csv_files = [] # refers to list of csv files
    cur_dir = os.getcwd() # fetches curr directory
...
def main():
    welcome()
    try:
        csv_files = checkcsv() # count no of csv files in the project directory and refers to list of csv file_names
        ...
        print("Now you can predict salary of employee using our model")
        print("\nEnter experiencen in years of the candidates, separated by comma")
